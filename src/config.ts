...
export const SIDEBAR: Sidebar = {
	en: {
		...
		'Autres actions': [
			...
			{ text: 'Filtrage', link: 'autre/filtrer' },
			...
			{ text: 'Orientation EXIF', link: '' },
			{ text: 'Utiliser les catégories sur tout type de fichiers', link: 'autre/utiliser' },
			{ text: 'Les modes Image et Plein écran', link: 'autre/mode' },
			{ text: 'ExifTool', link: 'autre/exiftool' },
			{ text: 'Favoris', link: 'autre/favori' },
			{ text: 'Reconnaissance de visages et importation de mots clés', link: 'autre/importation' },
			{ text: 'Rechercher', link: 'autre/rechercher' },
			{ text: 'Visualiser les panoramiques', link: 'autre/panoramique' },
			{ text: 'Description et Commentaire intégré ', link: 'autre/description' },
			{ text: 'Retouche avec un programme externe', link: 'autre/retouche' },
			{ text: 'Préparer des images pour Google photos', link: 'autre/google' },
			{ text: 'Recherche rapide', link: 'autre/rapide' },
			{ text: 'Personnalisation de XnViewMP', link: 'autre/personnaliser' },
			{ text: 'Annexes liens et documentation', link: 'autre/annexe' },
		],
	},
};
